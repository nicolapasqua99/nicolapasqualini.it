const { getCardsRef, getCardByIdRef, getOfferedCardsRef, getRequestedCardsRef, addSetRef, getUserRef, addCardsPackRef, addRarityRef, getRaritiesRef, addRelatedCardRef, addCardToRequestRef, removeCardFromRequestRef, addCardToUserRef, removeCardFromUserRef, updateCardQuantityRef, addUserRef, changeUserDisplayNameRef, changeUserEmailRef, changeUserLastLoginRef, getCardsBySetCodeRef, getCardsPossessedByUserRef, getPacksRef, getPacksAndCardsRef, addCardToOfferRef, removeCardFromOfferRef, addPackRef, getRelatedCardsRef, getSetsRef, addCardRef, connectorConfig } = require('../index.cjs.js');

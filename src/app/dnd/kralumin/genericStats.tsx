...
export default class GenericStats extends React.Component {
    ...
    componentDidMount() {
        const dbRefLevels = ref(getClientRealtimeDatabase(), 'dnd/kralumin/levels')
        ...
        const dbRefStats = ref(getClientRealtimeDatabase(), 'dnd/kralumin/basic_stats')
        ...
        const dbRefDexterity = ref(getClientRealtimeDatabase(), 'dnd/kralumin/abilities/dex/value')
        ...
        const dbRefSpeed = ref(getClientRealtimeDatabase(), 'dnd/kralumin/speed')

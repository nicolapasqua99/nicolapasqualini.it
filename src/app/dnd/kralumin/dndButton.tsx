...
export default class DNDButton extends React.Component<IDNDButtonProps> {
    ...
    componentDidMount(): void {
        const dbRef = ref(getClientRealtimeDatabase(), 'dnd/kralumin/spell_slots/')
    ...
    castSpell(castLevel: number) {
        const dbRefSlots = ref(getClientRealtimeDatabase(), 'dnd/kralumin/spell_slots/lv_' + castLevel)

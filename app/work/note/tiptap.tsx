...
const content = `
<h1>SPRINT 87 (21/05/2024 – 04/06/2024)</h1>
<ul>
<li></li>
<li></li>
<li></li>
...
const TipTapComponent = (props: { content: string; selected: number; index: number }) => {
    if (props.selected === props.index)
        return (
            <>
                <EditorProvider extensions={extensions} content={props.content} slotBefore={<MenuBar />} />
            </>
        )
}
